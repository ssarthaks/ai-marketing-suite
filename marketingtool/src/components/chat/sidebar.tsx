  ...
  return (
    ...
    >
                  ...
                  <li key={t.id}>
                    ...
                    >
                      ...
                      {!collapsed && editingId !== t.id && (
                        <div className="flex items-center gap-0.5 opacity-100 transition-opacity sm:gap-1.5 sm:opacity-0 sm:group-hover:opacity-100">
                          <button
                            type="button"
                          ...
                          <button
                            ...
                            className="inline-flex size-8 items-center justify-center rounded-md text-muted-foreground transition-colors hover:bg-background hover:text-destructive"
                          >
      ...
      <div className="border-t border-border p-2">
            ...
            <div className="mb-2">
              {!collapsed && (
                <div className="px-2 pb-1.5 pt-1 text-[10px] font-semibold uppercase tracking-wider text-muted-foreground/80">
                  Agent Products ({agentFiles.length})
                </div>
              )}
              ...
              {isLoadingProducts ? (
                ...
                <ul className="flex flex-col gap-0.5 max-h-[160px] overflow-y-auto custom-scrollbar pr-1">
                  {agentFiles.map((file) => {
                    ...
                    return (
                      <li key={file}>
                        <Link
                          ...
                          target="_blank"
                          className={cn(
                            "flex w-full items-center gap-2 rounded-lg px-2 py-1.5 text-sm text-muted-foreground transition-colors hover:bg-accent hover:text-foreground capitalize",
                            collapsed && "justify-center px-0",
                          )}
                          title={displayName}
                        >
        ...
        <button
          onClick={() => signOut({ callbackUrl: "/login?manual=1" })}
          title="Sign out"
          className={cn(
